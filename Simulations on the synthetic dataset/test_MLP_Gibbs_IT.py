...
imported_graph = tf.train.import_meta_graph('saved_new_mlp_%04d.meta'%(save_model_index))
##########################################################################################
...
with tf.Session(graph=g) as sess:
    ...
    imported_graph.restore(sess, './saved_new_mlp_%04d'%(save_model_index))
