...
np.savez('MLP_IT_Tanh.npz',train_acc=np.mean(acc_vector,axis=0),kld=np.mean(kld_vector,axis=0),MIFX_gibbs=MIFX_vector,MIFY_gibbs=MIFY_vector,MIFX_kde=MIFX_kvector, MIFY_kde=MIFY_kvector,MIFX_bin=MIFX_bvector,MIFY_bin=MIFY_bvector)
