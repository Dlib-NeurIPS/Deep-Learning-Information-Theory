...
case = 1
data = np.load('MLP_IT_bin_%1d_%s.npz'%(case,activation_func))
...
#if activation_func == 'relu':
#    axs[indexp].set_title('MLP1(8-6-2 ReLU)',fontsize=Fontsize)
#else:
#    axs[indexp].set_title('MLP2(8-6-2 Tanh)',fontsize=Fontsize)
axs[indexp].set_xlabel(r'$bs=%.3f$'%(bin_size1),fontsize=Fontsize)
...
axs[indexp].set_xscale('log')
axs[indexp].set_xlabel(r'$bs=%.3f$'%(bin_size2),fontsize=Fontsize)
#axs[indexp].set_ylabel(r'$I(X;T_i)$',fontsize=Fontsize)
axs[indexp].grid(True)
#axs[indexp].set_ylim(0.5, 2.5)
if activation_func == 'relu':
...
axs[indexp].set_xscale('log')
axs[indexp].set_xlabel(r'$bs=%.3f$'%(bin_size3),fontsize=Fontsize)
#axs[indexp].set_ylabel(r'$I(X;T_i)$',fontsize=Fontsize)
axs[indexp].grid(True)
#axs[indexp].set_ylim(0.5, 2.5)
if activation_func == 'relu':
...
axs[indexp].set_xscale('log')
axs[indexp].set_xlabel(r'$bs=%.3f$'%(bin_size4),fontsize=Fontsize)
